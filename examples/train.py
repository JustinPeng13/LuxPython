...
from v2 import AgentPolicy as AgentPolicyV3
from v4 import AgentPolicy as AgentPolicy
from rba import RuleBasedAgent
...
def get_command_line_arguments():
    ...
    parser.add_argument(
        "--n_steps",
        help="Number of experiences to gather before each learning period",
        type=int,
        default=2048,
    )
    parser.add_argument(
        "--path",
        help="Path to a checkpoint to load to resume training",
        type=str,
        default=None,
    )
    parser.add_argument(
        "--n_envs",
        help="Number of parallel environments to use in training",
        type=int,
        default=1,
    )
...
def train(args):
    ...
    opp_model = PPO.load(f"models/v7_step10000000.zip")
