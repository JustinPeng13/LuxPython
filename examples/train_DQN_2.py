...
from examples.agent_policy_DQN_2 import DQN_2_AgentPolicy
...
def get_command_line_arguments():
    ...
    parser.add_argument('--id', help='Identifier of this run', type=str, default="DQN2")
...
def train(args):
    ...
    player = DQN_2_AgentPolicy(mode="train")
    ...
    if args.n_envs == 1:
        ...
        env = SubprocVecEnv([make_env(LuxEnvironment(configs=configs,
                                                     learning_agent=DQN_2_AgentPolicy(mode="train"),
    ...
    player_replay = DQN_2_AgentPolicy(mode="inference", model=model)
    callbacks.append(
