    ...
    def get_reward(self, game, is_game_finished, is_new_turn, is_game_error):
        ...
        if is_game_finished:
            ...
            if game.get_winning_team() == self.team:
                ...
                rewards["rew/r_game_win"] = -40 * (
                    1.25 - game.state["turn"] / GAME_CONSTANTS["PARAMETERS"]["MAX_DAYS"]
                )  # Loss
            if random.randint(0, 99) < 5:
                print(
                    ...
                    Farming score: {farm_score * 50000}\n \
                    ...
                    Total score: {farm_score * 50000 + city_survival_score + rewards['rew/r_game_win'] + rewards['rew/r_city_tiles_end']}\n"
                )
